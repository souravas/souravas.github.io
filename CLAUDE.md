...
The dev server mirrors production routing: the `html-routes` plugin rewrites `/` → `/v1/index.html`, `/v2` → `/v2/index.html`, and `/v3` → `/v3/index.html`.
