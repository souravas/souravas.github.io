...
The dev server mirrors production routing: the `html-routes` plugin rewrites `/` → `/v1/index.html`, `/v2` → `/v2/index.html`, `/v3` → `/v3/index.html`, `/v4` → `/v4/index.html`, `/start` and `/start/v2` → `/start/v2/index.html`, and `/start/v1` → `/start/v1/index.html`.
